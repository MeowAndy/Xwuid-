...
```bash
git clone https://github.com/MeowAndy/Fzm-Xwuid-BJ-MB-Pic.git
```

然后把需要的目录复制到你的 GS Core 数据目录中，例如：
...
- ✅ 本仓库素材用于 XWUID 面板图库备份与分享。
- ✅ 可以自用、学习、恢复数据、给群友部署时参考。
- ❌ **禁止倒卖、二次售卖、打包收费。**
- ❌ 不要把本仓库素材包装成“付费专属资源”。
- 💬 如需联系/反馈：QQ `2408736708`。

如果这些素材帮到了你，欢迎点个 Star ⭐
